...
$(document).on(
				...
				function(event) {
					...
					$("#rdoGender").val($(this).closest("tr").find('td:eq(4)').text());
					$("#licen").val($(this).closest("tr").find('td:eq(5)').text());
					$("#special").val($(this).closest("tr").find('td:eq(6)').text());
					$("#docPhone").val($(this).closest("tr").find('td:eq(7)').text());
					$("#docCharge").val($(this).closest("tr").find('td:eq(8)').text());
